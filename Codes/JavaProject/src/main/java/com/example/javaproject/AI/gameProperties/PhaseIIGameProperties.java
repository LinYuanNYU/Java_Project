...
public class PhaseIIGameProperties extends GameProperties {
    ...
    public PhaseIIGameProperties(int numberOfPlayer, int numberOfHands, int initialMoney, int bigBlind, int smallBlind) {
...
//        addPlayer(new Player(2, getInitialMoney(), new PlayerControllerPhaseIIBluff(preFlopPersistence)));
//        addPlayer(new Player(3, getInitialMoney(), new PlayerControllerPhaseIINormal(preFlopPersistence)));
//        addPlayer(new Player(4, getInitialMoney(), new PlayerControllerPhaseIINormal(preFlopPersistence)));
    }
}
